...
if (file.exists("../AOS_precision/output/surface_comparison_test3.RData")){
  load("../AOS_precision/output/surface_comparison_test3.RData")
}
...
for (sp_code in species_to_fit$Species){
  ...
  runtime_integrated <- difftime( end,start, units="mins") # 18 min # 26 min with effort
  ...
  png(paste0("../AOS_precision/output/figures/",sp_code,"_plot1_PConly_test3.png"), width=6.5, height=8, units="in", res=300, type="cairo")
  ...
  png(paste0("../AOS_precision/output/figures/",sp_code,"_plot1_integrated_test3.png"), width=6.5, height=8, units="in", res=300, type="cairo")
  ...
  png(paste0("../AOS_precision/output/figures/",sp_code,"_plot2_PConly_test3.png"), width=6.5, height=8, units="in", res=300, type="cairo")
  print(pred_surface_map_PConly_q50)
  dev.off()
  ...
  png(paste0("../AOS_precision/output/figures/",sp_code,"_plot2_integrated_test3.png"), width=6.5, height=8, units="in", res=300, type="cairo")
  print(pred_surface_map_integrated_q50)
  dev.off()
  ...
  save(surface_comparison, file = "../AOS_precision/output/surface_comparison_test3.RData")
