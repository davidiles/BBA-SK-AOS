...
load("!Data_processed/SaskGrid_PCA.RData") # SHOULD ALREADY BE IN TARGET CRS
...
DO_to_use <- which(DO_surveyinfo$HSS >= -1 &
                     ...
                     DO_surveyinfo$yday <= end_date &
                     
                     DO_surveyinfo$ProtocolType %!in% c("Breeding Bird Atlas","Area search"))
