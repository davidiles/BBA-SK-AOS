...
for (sp_code in c("SPSA")){
  ...
  kappa_LT(sq_idx, model = "iid", constr = TRUE, hyper = list(prec = kappa_prec))+
  ...
  png(paste0("../AOS_precision/output/figures/",sp_code,"_q50_PConly.png"), width=6.5, height=8, units="in", res=300, type="cairo")
  print(pred_surface_map_PConly_q50)
  dev.off()
  ...
  png(paste0("../AOS_precision/output/figures/",sp_code,"_q50_integrated.png"), width=6.5, height=8, units="in", res=300, type="cairo")
  print(pred_surface_map_integrated_q50)
  dev.off()
