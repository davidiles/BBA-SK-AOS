...
# # ------------------------------------------------------
# # Optional code to create larger blocks (e.g., 100 km blocks)
# # ------------------------------------------------------
# 
...
# ext[4] <- ext[4] + 100000
# 
# grid <- raster(ext, resolution = 20000, crs = crs(SaskSquares))
...
#   scale_fill_gradientn(colors=viridis(5))
# 
# st_write(SaskSquares_xval,"../AOS_precision/output/SaskSquares_xval_20km.shp",append=FALSE)
