...
setwd("C:/Users/ilesd/OneDrive - EC-EC/Iles/Projects/Landbirds/SK_BBA_analysis/Standard_Analysis/")
`%!in%` <- Negate(`%in%`)
...
load("C:/Users/ilesd/OneDrive - EC-EC/Iles/Projects/Landbirds/SK_BBA_analysis/AOS_precision/data/Pointcount_data.RData")
...
# Pointcount_dataset: locations and covariates associated with each point count
load("C:/Users/ilesd/OneDrive - EC-EC/Iles/Projects/Landbirds/SK_BBA_analysis/AOS_precision/data/Checklist_data.RData")
...
for (sp_code in c("NOHA","AMAV","BRTH","SPSA")){
  if (file.exists("../AOS_precision/output/surface_comparison.RData")){
    load("../AOS_precision/output/surface_comparison.RData")
  }
  ...
  # Use PC only run for initial values
  ...
  png(paste0("../AOS_precision/output/figures/",sp_code,"_MAP1_q50_PConly.png"), width=6.5, height=8, units="in", res=300, type="cairo")
  print(pred_surface_map_PConly_q50)
  dev.off()
  ...
  png(paste0("../AOS_precision/output/figures/",sp_code,"_MAP1_q50_integrated.png"), width=6.5, height=8, units="in", res=300, type="cairo")
  print(pred_surface_map_integrated_q50)
  dev.off()
  
  # ---------------------------------------------
  # Generate plots WITH raw data plotted
  # ---------------------------------------------
  ...
  png(paste0("../AOS_precision/output/figures/",sp_code,"_MAP2_q50_PConly.png"), width=6.5, height=8, units="in", res=300, type="cairo")
  print(pred_surface_map_PConly_q50)
  dev.off()
  ...
  pred_surface_map_integrated_q50 <- ggplot() +
    ...
    # Gray squares where checklists were collected
    geom_sf(data = subset(SaskSquares_species,!is.na(observed_CL)),size=0.1,show.legend = F, col = "gray70", fill = "transparent")+
    
    # Black diamond where species was observed in checklists
    geom_sf(data = subset(SaskSquares_species_centroids,observed_CL > 0 & !is.na(observed_CL)),size=0.75,show.legend = F, col = "black", shape = 5)+
  ...
  png(paste0("../AOS_precision/output/figures/",sp_code,"_MAP2_q50_integrated.png"), width=6.5, height=8, units="in", res=300, type="cairo")
  print(pred_surface_map_integrated_q50)
  dev.off()
  
  # # ---------------------------------------------
  # # Generate plots with different color scale (relevant to birders)
  # # ---------------------------------------------
  # 
  # raster_pred_surface_PConly <- cut.fn2(df = pred_grid_sp,
  #                                       column_name = "pred_PConly_med",
  ...
  # #print(pred_surface_map_PConly_q50)
  # 
  # png(paste0("../AOS_precision/output/figures/",sp_code,"_MAP3_q50_PConly.png"), width=6.5, height=8, units="in", res=300, type="cairo")
  # print(pred_surface_map_PConly_q50)
  # dev.off()
  # 
  # pred_surface_map_integrated_q50 <- ggplot() +
  ...
  # #print(pred_surface_map_integrated_q50)
  # 
  # png(paste0("../AOS_precision/output/figures/",sp_code,"_MAP3_q50_integrated.png"), width=6.5, height=8, units="in", res=300, type="cairo")
  # print(pred_surface_map_integrated_q50)
  # dev.off()
